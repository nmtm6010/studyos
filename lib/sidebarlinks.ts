...
export const sidebarlinks = {
    ...
    calendar: [
        ...
        { name:"Manage Events", href:"/calendar/events"},
        { name:"Planner", href:"/calendar/planner"},
    ...
    study: [
        ...
        { name:"Quizzes", href:"/study/quizzes"},
        { name:"Tests", href:"/study/tests"},
        { name:"Create", href:"/study/create"},
        { name:"Review", href:"/study/review"},
        { name:"Smart analyze", href:"/study/analyze"},
